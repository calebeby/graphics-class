...
<p.TransformDemo client:load initial_transforms={[
  new t.TranslateTransform(0, 0.5, 0)
]}/>
...
<p.TransformDemo client:load initial_transforms={[
  new t.ScaleTransform(0.5, 1.5, 1.0)
]}/>
...
<p.TransformDemo client:load initial_transforms={[
  new t.ReflectTransform(t.Axis.X)
]}/>
...
<p.TransformDemo client:load initial_transforms={[
  new t.SkewTransform(0.5, 0, t.Axis.X)
]}/>
...
<p.TransformDemo client:load initial_transforms={[
  new t.RotateTransform(45, t.Axis.Y)
]}/>
